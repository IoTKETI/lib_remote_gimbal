...
function key_to_signal(ch_num, ch_val) {
    try {
        ...
        } else if (ch_num === 2) {  // Tilt UP/DOWN
            ch2_target_val = ch_val;
        } else if (ch_num === 3) {
            ch3_target_val = ch_val;
        } else if (ch_num === 4) {  // Pan Right/LEFT
            ch4_target_val = ch_val;
        } else if (ch_num === 5) {  // Operation Mode
            ch5_target_val = ch_val;
        } else if (ch_num === 6) {  // Tilt Rate
            ch6_target_val = ch_val;
        } else if (ch_num === 7) {  // Pan Rate
            ch7_target_val = ch_val;
        } else if (ch_num === 8) {
            ch8_target_val = ch_val;
        } else if (ch_num === 9) {  // CAMERA ZOOM
            ch9_target_val = ch_val;
        } else if (ch_num === 10) {
            ch10_target_val = ch_val;
        } else if (ch_num === 11) {  // CAMERA REC
            ch11_target_val = ch_val;
        } else if (ch_num === 12) {  // CAMERA POWER
